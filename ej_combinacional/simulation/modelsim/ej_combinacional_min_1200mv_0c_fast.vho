...
SIGNAL \inst|led~0_combout\ : std_logic;
SIGNAL \inst|ALT_INV_led~0_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\inst|ALT_INV_led~0_combout\ <= NOT \inst|led~0_combout\;
...
\inst|led~0\ : cycloneiii_lcell_comb
-- Equation(s):
